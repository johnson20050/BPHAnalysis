#ifndef BPHAnalysis_SpecificDecay_mytestLbAnalyzer_h
#define BPHAnalysis_SpecificDecay_mytestLbAnalyzer_h
...
class mytestLbAnalyzer:
      public BPHAnalyzerWrapper<BPHModuleWrapper::one_analyzer> {

 public:

  explicit mytestLbAnalyzer( const edm::ParameterSet& ps );
  virtual ~mytestLbAnalyzer();
