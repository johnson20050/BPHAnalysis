...
recoSelect = cms.VPSet(
    ...
    cms.PSet( name = cms.string( 'LbToLam0' ),
        mPsiMin = cms.double( 2.90 ),
        mPsiMax = cms.double( 3.20 ),
        mLam0Min= cms.double( 1.000 ),
        mLam0Max= cms.double( 1.300 ),
    ...
    cms.PSet( name = cms.string( 'Kshort' ),
          ptMin = cms.double( 0.7 ),
         etaMax = cms.double(  2.5 ),
        massMin = cms.double( 0.25 ),
        massMax = cms.double( 1.00 ),
        probMin = cms.double( 0.05 ),
        constrMass  = cms.double( 0.497611 ),
        constrSigma = cms.double( -1.0 )
    ),
