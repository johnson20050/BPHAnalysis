...
class GenInfoBranches{//{{{
    public:
        ...
        void regTree(TTree *root){//{{{
            ...
            root->Branch("GenInfo.vx"           ,vx             ,"GenInfo.vx[GenInfo.size]/D");
            root->Branch("GenInfo.vy"           ,vy             ,"GenInfo.vy[GenInfo.size]/D");
            root->Branch("GenInfo.vz"           ,vz             ,"GenInfo.vz[GenInfo.size]/D");
            ...
            root->Branch("GenInfo.pdf_id"       ,pdf_id         ,"GenInfo.pdf_id[2]/I");
            root->Branch("GenInfo.pdf_x"        ,pdf_x          ,"GenInfo.pdf_x[2]/D");
            root->Branch("GenInfo.pdf_xPDF"     ,pdf_xPDF       ,"GenInfo.pdf_xPDF[2]/D");
            root->Branch("GenInfo.pdf_scalePDF" ,&pdf_scalePDF   ,"GenInfo.pdf_scalePDF/D");
        ...
        void setbranchadd(TTree *root){//{{{
            ...
            root->SetBranchAddress("GenInfo.vx"           ,vx             );
            root->SetBranchAddress("GenInfo.vy"           ,vy             );
            root->SetBranchAddress("GenInfo.vz"           ,vz             );
            ...
            root->SetBranchAddress("GenInfo.pdf_id"       ,pdf_id         );
            root->SetBranchAddress("GenInfo.pdf_x"        ,pdf_x          );
            root->SetBranchAddress("GenInfo.pdf_xPDF"     ,pdf_xPDF       );
            root->SetBranchAddress("GenInfo.pdf_scalePDF" ,&pdf_scalePDF  );
